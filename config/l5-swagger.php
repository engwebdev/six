...
//            'base' => env( 'L5_SWAGGER_BASE_PATH', 'localhost' ),
                ...
                'passport' => [ // Unique name of security
                    ...
                    'flows' => [
                        "password" => [
                            ...
                            "refreshUrl" => config( 'app.url' ) . '/api/v1/token/refresh',
                            "scopes" => [],
                        ],
                    ],
                ],
        ...
        */
         ...
         */
         'constants' => [
         'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', env('APP_URL')), // working
