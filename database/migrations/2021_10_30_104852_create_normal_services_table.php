...
class CreateNormalServicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('normal_services', function (Blueprint $table) {
            ...
            $table->string( 'normal_service_last_price_date' )->comment( 'تاریخ وارد کردن اخرین قیمت از جدول قیمتها' )->nullable();
            ...
            $table->unsignedBigInteger( 'normal_service_category_id' )->nullable()->comment( 'ای دی دسته بندی محصول از دسته بندی های محصولات' );
            $table->string( 'normal_service_category_name' )->nullable()->comment( 'ای دی دسته بندی محصول سفارشی از دسته بندی های محصولات سفارشی' );

            $table->unsignedBigInteger('normal_service_shop_id')->nullable();
            $table->unsignedBigInteger( 'normal_service_registry_shopkeeper_id' )->nullable();
