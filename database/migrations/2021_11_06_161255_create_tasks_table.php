...
class CreateTasksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tasks', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('task_registry_user_id')->nullable();
...
//            $table->foreign( 'task_unit_of_measurement_id')
//                ->references('id')
//                ->on('unit_of_measurement')
//                ->onDelete('no action')
//                ->onUpdate('cascade');
...
//                ->onUpdate('cascade');
            ...
            $table->foreign('task_registry_user_id')
                ->references('id')
                ->on('users')
                ->onDelete('no action')
                ->onUpdate('cascade');
