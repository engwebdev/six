...
class CreateCustomServicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('custom_services', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger( 'custom_services_registry_shopkeeper_id' )->nullable();
...
//                ->onDelete( 'set null' );
            ...
            $table->foreign( 'custom_services_registry_shopkeeper_id' )
                ->references( 'id' )
                ->on( 'users' )
                ->onDelete( 'set null' );
